...
//  Created by GGiOS on 2017-01-28.
...
class StoreManager: NSObject {
    ...
    var purchasableProductsIds:Set<String> = ["JustinaCollection","KarlaJaraCollection","LoCollection"]  //For now we only have one product
   ...
   let nonConsumablesProductsIds:Set<String> = ["JustinaCollection","KarlaJaraCollection","LoCollection"]
...
extension StoreManager{
    ...
    func savePurchasedProduct(id:String){
        ...
        UserDefaults(suiteName: "group.com.emoji.test")!.set(true, forKey: id)
    ...
    func isPurchased(id:String)->Bool{
        ...
        return UserDefaults(suiteName: "group.com.emoji.test")!.bool(forKey: id)
    }
}
